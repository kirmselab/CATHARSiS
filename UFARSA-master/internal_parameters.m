...
opt.negPrctileLevel     = 10;      % standard: 2; negative percentile level, used in the negative-deflections removal step
opt.scaleRep_negDefl    = 0.1;     % standard: 0.5
...
opt.max_smoothing_param = 1000;    % if smoothing_param is larger than opt.max_smoothing_param, then smoothing_param = opt.max_smoothing_param 
